...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter
{
    ...
    // they will go to: app.com/login
    // they will send header: client/clientsecret
    // they will send body: username / password / grant type
    // they will recieve a token

    // they will go to: app.com/dadjokes/getprivate
    // they will send: header: token
    // they will recieve: body: just dad jokes private
}